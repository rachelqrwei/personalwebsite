    ...
    return (
      <div className='fixed top-0 left-0 w-screen h-screen bg-gradient-to-b from-[#2B2719] to-[#201910] flex items-center justify-center z-1000'>
        <div className='flex flex-col items-center justify-center'>
          <l-trefoil stroke='9' size="80" speed="2" color="wheat"></l-trefoil>
          {/* <l-line-wobble stroke='8' size="170" speed="2" color="wheat"></l-line-wobble> */}
          {/* <l-waveform stroke='8' size="70" speed="2" color="wheat"></l-waveform>  */}
