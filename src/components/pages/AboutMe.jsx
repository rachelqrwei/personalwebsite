...
const AboutMeModal = () => {
    ...
    return (
        ...
        >
            <div className="portrait:h-[70vh] landscape:h-[60vh] landscape:md:h-[78vh] mr-1">
                <div className="relative w-[22.5rem] h-[36rem] bg-center rounded-[3px] p-5 bg-[url('/images/papertexture-22.png')] bg-cover">
                    ...
                    <div className="absolute text-xs text-[#745C4E] ml-[10.8rem] mt-[3.5rem] p-2  w-[7.8rem] h-[4.7rem] bg-[#F8E6D4] rounded-[1px]">
                        Hi! I'm Rachel Wei, and I'm a CS BBA student from Toronto!
                    </div>
                    <div className="absolute text-xs text-[#745C4E] ml-[9.4rem] mt-[17.9rem] p-2 w-[10.3rem] h-[5rem]  bg-[#F8E6D4] rounded-[1px]">
                        I'm passionate about combining technical skills with my artistic flair to bring ideas to life.
                    </div>
                    <div className="absolute ml-[0.2rem] mt-[24rem] w-[7rem] h-[5.3rem] pt-2 px-3 text-xs text-[#745C4E] bg-[#F8E6D4] rounded-[1px]">
                        Thanks for checking out my website!
                    </div>

                    {/* image elements */}
                    <div className={`absolute ml-[17.2rem] mt-[6.5rem] w-[2.1rem] h-[2.1rem] bg-[url('/images/aboutme-star.png')] pointer-events-none bg-center bg-contain z-50`}></div>
                    <div className={`absolute ml-[3.0rem] mt-[2.9rem] w-[7rem] h-[7rem] bg-[url('/images/aboutme-grad.png')] ${imageBoxShadow}`}></div>
                    <div className={`absolute ml-[1.0rem] mt-[10.8rem] w-[10rem] h-[6.3rem] bg-[url('/images/aboutme-baby.png')] ${imageBoxShadow}`}></div>
